        ...
        <div class="card-body">
            <table class="table tabe-hover table-bordered" id="list">
                ...
                <tbody>
                    ...
                    $qry = $conn->query("SELECT f.*, concat(f.firstname,' ',f.lastname) as name, d.name as department_name FROM faculty_list f LEFT JOIN department_list d ON f.department_id = d.id ORDER BY name ASC");
                    ...
                    <tr>
                        ...
                        <td><b><?php echo $row['department_name'] ?></b></td> <!-- Display Department -->
